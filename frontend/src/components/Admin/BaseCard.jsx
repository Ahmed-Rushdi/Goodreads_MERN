...
const BaseCard = ({ children, handleEdit, dataId, handleDelete }) => {
  ...
  return (
    <div className="bg-white shadow-sm hover:shadow-md  p-3 h-60 flex flex-col border border-buff rounded-sm w-full m-4 sm:w-[calc(100%/2-2rem)] md:w-[calc(100%/3-2rem)] lg:w-[calc(100%/4-2rem)]">
