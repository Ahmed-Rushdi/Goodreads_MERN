...
const BaseCard = ({ children, handleEdit, dataId, handleDelete }) => {
  ...
  return (
    <div className="bg-white shadow-sm hover:shadow-md p-3 h-60 flex flex-col border border-buff rounded-sm w-full m-2 sm:w-[calc(100%/2-1rem)] md:w-[calc(100%/3-1rem)] lg:w-[calc(100%/4-1rem)]">
